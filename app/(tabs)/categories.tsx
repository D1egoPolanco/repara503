...
const categories = [
	{
		id: 1,
		name: 'Motor',
		icon: (props) => <MaterialCommunityIcons name="engine" {...props} />,
		color: '#4CAF50',
	},
	{
		id: 2,
		name: 'Escape',
		icon: (props) => <MaterialCommunityIcons name="tailpipe" {...props} />,
		color: '#FF9800',
	},
	{
		id: 3,
		name: 'Suspensión',
		icon: (props) => <MaterialCommunityIcons name="car-suspension" {...props} />,
		color: '#2196F3',
	},
